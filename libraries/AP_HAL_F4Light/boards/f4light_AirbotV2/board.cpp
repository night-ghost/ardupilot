...
//               name            device   bus  mode         cs_pin                 speed_low       speed_high   dma               priority
     ...
     { BOARD_SDCARD_NAME,        _SPI2,   2,  SPI_MODE_3, BOARD_SDCARD_CS_PIN,     SPI_562_500KHZ, SPI_18MHZ,  SPI_TRANSFER_DMA, DMA_Priority_Medium,     2,  2, true  },
     { HAL_BARO_BMP280_NAME,     _SPI3,   3,  SPI_MODE_3, BOARD_BMP280_CS_PIN,     SPI_1_125MHZ,   SPI_9MHZ,   SPI_TRANSFER_DMA, DMA_Priority_High,       1,  1, false },
     { BOARD_OSD_NAME,           _SPI3,   3,  SPI_MODE_0, BOARD_OSD_CS_PIN,        SPI_1_125MHZ,   SPI_4_5MHZ, SPI_TRANSFER_DMA, DMA_Priority_Low,        2,  2, false },
};
