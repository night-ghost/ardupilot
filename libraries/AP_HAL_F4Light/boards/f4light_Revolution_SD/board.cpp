...
//   { BOARD_DATAFLASH_NAME,     _SPI3,   3,  SPI_MODE_3, 255 /* caller controls CS */, SPI_1_125MHZ,   SPI_18MHZ, SPI_TRANSFER_DMA, DMA_Priority_Medium,   0,         1,         true }, // we can use dataflash as EEPROM
     { BOARD_SDCARD_NAME,        _SPI3,   3,  SPI_MODE_3, BOARD_SDCARD_CS_PIN,          SPI_562_500KHZ, SPI_18MHZ, SPI_TRANSFER_DMA, DMA_Priority_Medium,   0,         1,         true },
};
